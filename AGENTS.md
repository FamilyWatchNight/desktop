...
This project uses a three-layer BDD architecture inspired by _BDD in Action_:
...
- `dev` text is the English text with underscores (\_\_\_) affixed to the start and end for easy identification
