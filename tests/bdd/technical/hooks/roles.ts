...
export class Roles {
  ...
  async createRole(
    ...
    return await withTestHooks(
      this.app,
      async (hooks, name, permissionStubs, authContext) => {
  ...
  async getRolePermissions(roleId: number, authContext?: AuthContextPayload): Promise<string[]> {
    return await withTestHooks(
      this.app,
      async (hooks, roleId, authContext) => {
  ...
  async setRolePermissions(
    ...
    return await withTestHooks(
      this.app,
      async (hooks, roleId, permissionStubs, authContext) => {
  ...
  async updateRole(
    ...
    return await withTestHooks(
      this.app,
      async (hooks, id, data, authContext) => {
  ...
  async updateRoleDisplayName(
    ...
    return await withTestHooks(
      this.app,
      async (hooks, id, displayName, authContext) => {
  ...
  async updateRoleHiddenStatus(
    ...
    return await withTestHooks(
      this.app,
      async (hooks, id, isHidden, authContext) => {
  ...
  async duplicateRole(sourceRoleId: number, authContext?: AuthContextPayload): Promise<number> {
    return await withTestHooks(
      this.app,
      async (hooks, sourceRoleId, authContext) => {
