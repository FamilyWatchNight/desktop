...
type StepDefinitionBody = (this: unknown, ...args: unknown[]) => Promise<unknown> | unknown;
...
function createStepRegistryEntry(
  pattern: string | RegExp,
  fn: StepDefinitionBody,
  options: StepOptions,
): RegisteredStep {
...
export function findRegisteredStep(
  stepText: string,
): { step: RegisteredStep; args: unknown[] } | null {
...
export function defineGiven(
  pattern: string | RegExp,
  optionsOrFn: StepOptions | StepDefinitionBody,
  fn?: StepDefinitionBody,
): void {
